...
export default function LawyerSignUp({ onBackToHome, onNavigateToSignIn, onNavigateToLawyersListings }: LawyerSignUpProps) {
      ...
      >
        ...
        >
          <h1 className="text-[28px] sm:text-[32px] font-light">
            Connect. <span className="text-primary">Resolve.</span> Protect.
          </h1>
        </motion.div>
